...
\begin{figure}[t!]
  \includegraphics[width=0.48\textwidth,clip=]{gd1_evol_aadohist.eps}
...
value of $\mu_\Omega$. In particular, if the progenitor has internal
rotation the action distribution of the debris and $\mu_\Omega$ may be
...
\begin{figure*}[t!]
\begin{center}
  \includegraphics[width=0.36\textwidth,clip=]{gd1_evol_aaaparopar.ps}
  \includegraphics[width=0.36\textwidth,clip=]{gd1_evol_aaaparoperp.ps}\\
  \includegraphics[width=0.36\textwidth,clip=]{gd1_evol_aaaparaperp.ps}
  \includegraphics[width=0.36\textwidth,clip=]{gd1_evol_aaapartime.ps}
...
\[
\protect{\mathrm{\url{http://jobovy.github.io/galpy/streamdf.html}}}\,.
\]
