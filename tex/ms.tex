...
\figurename~\ref{fig:gd1_xy}. \figurename~\ref{fig:gd1_jt} shows the
...
\begin{figure}[t!]
  ...
  \caption{Mock tidal stream simulated as described in
    ...
    progenitor orbit.}\label{fig:gd1_xy}
...
\begin{figure}[t!]
  ...
  \caption{Properties of the simulated tidal stream of
    ...
    with a period of roughly $40\Myr$ (the radial period of the
