%BOVY:NOTES:
% - GO through citations and be a little more reluctant to cite Sanders
% - do more justice to Eyre & Binney work
% - discuss hotter streams somewhere
% - say more about why dynammical large-scale modeling doesn't care about the small-scale structure
% - what about spherical potentials? dO/dJ has zero eigenvalue
% - We/I distinction
...
\end{split}
\end{equation}
\Eqnname~(\ref{eq:poparapar}) shows why we chose to model $p(\Delta
